...
class Policy(torch.nn.Module):  #Sub-class of NN PyTorch class
    """ Policy neural network and gaussian distribution construction"""
...
class Agent(object):
    ...
    def update_policy(self):
        """Optimization step of the policy (and value if Actor-Critic)"""
    ...
    def get_action(self, state, evaluation=False):
        ...
        @return normal_dist action gaussian distribution
        """
